        ...
        <div id="slider-direction-1" class="t-cn slider-direction">
            <div class="slider-content s-tb slide-1">
                <div class="title-container s-tb-c">
                    ...
                    <p>Kini Mendaftar ke SMK Putra Rifara lebih Mudah Daftar dari rumah.</p>
        ...
        <div id="slider-direction-2" class="t-cn slider-direction">
            <div class="slider-content s-tb slide-2">
                <div class="title-container s-tb-c">
                    ...
                    <p>Jadikan Sekolah SMK Putra Rifara sebagai tempat dirimu menggapai mimpi.</p>
                    <div class="slider-btn-area">
                        <a href="{{route('register')}}" class="default-big-btn">Daftar</a>
                    </div>
                </div>
            ...
            <div class="row service1-wrapper">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 service-box1">
                    <div class="service-box-content">
                        ...
                        <p>Beasiswa untuk murid berprestasi, Akademik atau Non-Akademik.</p>
                    </div>
