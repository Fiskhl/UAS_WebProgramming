...
<head>
    ...
    <meta name="description" content="MyYPR adalah aplikasi manajemen sekolah berbasis website yang di bangun dan di kembangkan dengan Framework Laravel">
    <meta name="keywords" content="">
    <meta name="author" content="">
    <title>Register Page - MyYPR</title>
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="/">
                            <img class="img-responsive" src="{{asset('Assets/Frontend/img/ypr2.png')}}" alt="logo">
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                @endif
                                <h2 class="card-title font-weight-bold mb-1">Welcome to MyYPR! 👋</h2>
                                <p class="card-text mb-2">Pendaftaran PPDB SMK Putra Rifara</p>
