        ...
        <div class="row">
                ...
                <div class="card card-congratulations">
                    <div class="card-body text-center">
                        ...
                        <div class="text-center">
                            <h1 class="mb-1 text-white">Selamat Bergabung {{Auth::user()->name}},</h1>
                            <p class="card-text m-auto w-75">
                                Semoga kamu giat belajar :)
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-5">
                <div class="card card-congratulation-medal">
                    ...
                    <p class="card-text font-small-3">Kamu diterima menjadi murid di SMK Putra Rifara</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <small>Teluknaga, Kab. Tangerang</small>
                            </div>
                        </div>
